...
Please note that Macs that use M1 chips currently 9do not support TensorFlow)[https://github.com/dotnet/machinelearning/blob/main/docs/project-docs/platform-limitations.md] and cannot make use of NsfwSpy.
